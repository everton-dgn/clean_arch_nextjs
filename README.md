...
- [Como instalar e executar o projeto](#question-como-instalar-e-executar-o-projeto)
  ...
  - [Iniciar Ambiente de Desenvolvimento](#iniciar-ambiente-de-desenvolvimento)
  - [Gerar Build de Produção](#gerar-build-de-produção)
  - [Iniciar Ambiente de Produção](#iniciar-ambiente-de-produção)
  - [Executar Testes](#executar-testes)
  - [Executar Testes em Modo Watch](#executar-testes-em-modo-watch)
  - [Executar Lints](#executar-lints)
  - [Formatar código com BiomeJS](#formatar-código-com-biomejs)
  - [Verificar Atualizações Disponíveis para Dependências](#verificar-atualizações-disponíveis-para-dependências)
...
- [x] Detecção prefers-reduced-motion;
